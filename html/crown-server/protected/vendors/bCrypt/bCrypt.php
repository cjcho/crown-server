<?
/*
* bCrypt class and implementation based off http://www.yiiframework.com/wiki/292/secure-password-hashing-with-bcrypt/
* Original discussion at http://stackoverflow.com/questions/4795385/how-do-you-use-bcrypt-for-hashing-passwords-in-php
*
* "Keep it safe, keep it secret." - Gandalf the Grey
*
*/
class bCrypt {
